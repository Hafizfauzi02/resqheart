...
class Heartrate2 extends StatefulWidget {
  ...
  @override
  State<Heartrate2> createState() => _HeartrateState2();
}

class _HeartrateState2 extends State<Heartrate2> {
...
class DateDetailsPage extends StatelessWidget {
  ...
  const DateDetailsPage({required this.date, super.key});
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: 20),
                        _buildIndicator("NORMAL", Colors.green),
                        SizedBox(width: 20),
 ...
 Widget _buildLastScannedSection(double screenWidth, double screenHeight, DateTime date) {
  ...
  // Function to build healthy heart info section
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 10),
              _buildResultItem("✔ NORMAL Heart Rate", LucideIcons.checkCircle),
              _buildSubItem("• Range: 60 - 100 BPM"),
              _buildSubItem("• Indicates a healthy cardiovascular system"),
              Divider(thickness: 1),
              _buildResultItem("📌 Benefits", LucideIcons.activity),
              _buildSubItem("  - Efficient blood circulation"),
              _buildSubItem("  - Stable oxygen delivery"),
              Divider(thickness: 1),
              _buildResultItem("🍎 Lifestyle Factors", LucideIcons.apple),
              _buildSubItem("  - Regular exercise 🏃‍♂️"),
              _buildSubItem("  - Healthy diet (fruits, veggies, lean protein) 🥦"),
              _buildSubItem("  - Stress management (meditation, deep breathing) 🧘‍♂️"),
              Divider(thickness: 1),
              _buildResultItem("📊 Monitoring Tips", LucideIcons.stethoscope),
              _buildSubItem("  - Check heart rate regularly 💓"),
              _buildSubItem("  - Stay hydrated 💧"),
              _buildSubItem("  - Get enough sleep (7-9 hours) 😴"),
            ],
          ),
        ),
      ],
