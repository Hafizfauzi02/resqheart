...
class Highhearthome extends StatefulWidget {
  const Highhearthome({super.key});

  @override
  State<Highhearthome> createState() => _HighHeartHomeState();
}

class _HighHeartHomeState extends State<Highhearthome> {
        ...
        Row(
          ...
          children: [
            Container(
              ...
              child: Center(
                child: Text('16/03/2025', // Display dynamic date
                  textAlign: TextAlign.center,
                          ...
                          GestureDetector(
                            onTap: () {
                              ...
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => DateDetailsPage3(date: selectedDate),
                                ),
                              );
                            },
                            child: Row(
